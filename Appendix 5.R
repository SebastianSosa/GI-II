...
# Set parameters
N <- c(30, 35, 40, 50, 60, 70, 80, 100, 120, 125, 130, 135, 140, 145, 150)
n.obs <- c(30, 35, 40, 45, 50, 55, 60)
...
for (a in a:nrow(params)) {
  ...
  for(b in 1:100){
    ...
    cat("Parametric false positives rates with residual correction for degree: ", (nrow(result0.2[result0.2$p < 0.05,])*100)/nrow(result0.2), "\n")
